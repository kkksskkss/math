...
createCanvas(windowWidth,windowHeigt);
// Movendo plano de fundo
path=createSprite(windowWidth,windowHeigt);
path.addImage(pathImg);
path.velocityY = 4;


//criar menino correndo 
boy = createSprite(windowWidth,windowHeigt,20,20);
...
function draw() {
  ...
  if(gameState===PLAY){
  background(windowHeigt,windowHeigt);
  boy.x = World.mouseX;
  ...
  textSize(20);
  fill(255);
  text("Tesouro: "+ treasureCollection,width-150,height-30);
  }
